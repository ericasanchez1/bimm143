...
Functions are how we get work done in R. We call functions to do everything fron reading data to doing analysis and outputing plots and results. 
...
I have to find the NA (TRUE) values from `is.na()` now I want to make them equal to zero (overwrite them/mask them)
